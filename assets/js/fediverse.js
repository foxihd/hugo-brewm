    ...
    if (mstdAPI !== tootURL) {
        ...
        const loadMstdAPI = async () => {
            ...
            try {
                ...
                mstdRoot.innerHTML = `<div role="alert" class="er">[Mastodon] <br> ${i18nErr} : ${error}</div>`;
            }
        }
