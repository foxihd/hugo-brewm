...
<fieldset id="a11y" aria-label="${i18nAccessibility}">
  <div id="optimizeSR">
    <input id="useSR" class="toggle" type="checkbox" onclick="useSreenReader()"><label for="useSR" aria-description="${i18nOptimizesrdesc}">${i18nOptimizesr}</label>
  </div>
  ...
  <div id="setFontSize" class="has-aria-label-top sri" aria-label="${i18nFontsize}">
    <form class="range" for="fontSize" oninput="setFontSize()">
      <input id="fontSize" type="range" min="8" max="12" step="0.5" aria-label="${i18nFontsize}">
  ...
  <div id="setBaselineStretch" class="has-aria-label-top sri" aria-label="${i18nBaselinestretch}">
    <form class="range" for="baselineStretch" oninput="setStretch()">
      <input id="baselineStretch" type="range" min="0.8" max="1.2" step="0.05" aria-label="${i18nBaselinestretch}" >
      <output id="baselineStretchState" for="baselineStretch" role="status" aria-live="polite">1</output>
    </form>
  </div>
  <div id="setOpenDyslexic" class="sri">
    <input id="OpenDyslexic" class="toggle" type="checkbox" onclick="useOpenDyslexic()"><label for="OpenDyslexic" aria-label="${i18nOpendyslexic}">${i18nOpendyslexic}</label>
  </div>
...
if (isPage) {
    ...
    <input id="defocusAuxElement" accesskey="d" type="checkbox" onclick="focusMode()" aria-label="${i18nFocusmode}"><label id="focusModeButton" for="defocusAuxElement" aria-label="${i18nFocusmode}">⦿ <span class="t" role="tooltip">${i18nFocusmode}</span></label>
    `;
